<template>
	<view class="uni-numbox">
		...
		<input disabled="disabled" v-model="inputValue"  class="uni-numbox__value" type="number" @blur="_onBlur" v-bind:style="{'color':numberBoxStyle&&numberBoxStyle.inputColor?numberBoxStyle.inputColor+'!important':'#444444','background':numberBoxStyle&&numberBoxStyle.inputBg?numberBoxStyle.inputBg+'!important':''}">
