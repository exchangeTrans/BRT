	...
	<view class="changeEmail" id="changeEmail">
		...
		<view class="wrap">
			<view class="changePhoneTop" :style="{'background-image':topBg}">
				...
				<view class="oldPhone">
					<loginInput :iconShow="true" :iconSrc="smsVerifyCode" :placeHolder="'输入当前邮箱验证码'" :lastTextShow="true" :lastText="'发送验证码'"
			...
			<view  class="phoneRegsFlag">
				...
				<!--</view>-->
				<loginInput :iconShow="true" :iconSrc="emailIcon" :firstTextShow="true"
							:placeHolder="'请输入新绑定邮箱'" @inputChange="inputChange('phone', $event)"></loginInput>
				<loginInput :iconShow="true" :iconSrc="smsVerifyCode" :placeHolder="'请输入新邮箱验证码'" :lastTextShow="true" :lastText="'发送验证码'"
							:lastTextStyle="phoneLastTextStyle" @lastTextClick="sendSmsVerify" @inputChange="inputChange('smsVerifyCode', $event)"></loginInput>
