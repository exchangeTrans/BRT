<template>
	<view class="regs" id="regs">
		...
		<view class="wrap">
			<loginHead :defaultChoice="defaultChoice" :leftText="leftText" :rightText="rightText" @typeChange="typeChange"></loginHead>
			...
			<view v-show="type === 'EMAIL'" class="emailRegsFlag">
				<loginInput :wrapStyle="emailStyle" :iconShow="true" :iconSrc="emailIcon" :placeHolder="'请填写电子邮件'" @inputChange="inputChange('email', $event)"></loginInput>
				<loginInput :iconShow="true" :iconSrc="smsVerifyCode" :lastTextShow="true" :lastText="'发送验证码'" :placeHolder="'邮箱验证码'" @inputChange="inputChange('emailVerify', $event)"></loginInput>
				<loginInput :iconShow="true" :iconSrc="passwordIcon" :placeHolder="'请输入6-20位登录密码'" @inputChange="inputChange('emailPassword', $event)"></loginInput>
				<loginInput :iconShow="true" :iconSrc="passwordIcon" :placeHolder="'请再次输入6-20位登录密码'" @inputChange="inputChange('emailSurePassword', $event)"></loginInput>
				<loginInput :wrapStyle="inviteWrapStyle" :iconShow="true" :iconSrc="inviteCode" :placeHolder="'请填写邀请码（选填）'"
