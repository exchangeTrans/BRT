<template>
    <view class="aboutUs" id="aboutUs" :style="{'background-image':'url('+welcomeBg+')'}">
        ...
        <view class="promotion">
            <view class="qeCodeBox">
                <uni-qrcode cid="qrcodeVis" @makeComplete="makeComplete" ref="qrcodeVis" :text="codeUrl" :size="size"
                            backgroundColor="rgba(255,255,255,0)"/>
            </view>
            <view class="inviteCode">{{$t('share').inviteCode}}：{{userInfo.inviteCode}}</view>
        </view>


        <view class="btnGroup">
            <view class="btnItem" @tap="saveImage">{{$t('share').saveImg}}</view>
            <view class="btnItem  copy" @tap="copy">{{$t('share').copyLink}}</view>
